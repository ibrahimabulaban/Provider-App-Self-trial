...
import {
  getPaymentSummary as onGetPaymentSummary,
  deletePaymentSummary as onDeletePaymentSummary,
} from "../../../../slices/thunk";
  ...
  const columns: columnsType[] = useMemo(
    () => [
      ...
      },
      {
        ...
        Filter: false,
        isSortable: true,
        Cell: (cell: any) => <>${cell.row.original.billed}</>,
      },
      {
        Header: "PAYMENT TYPE",
        ...
        <div className="col-sm-auto ms-auto">
          <Dropdown className="d-flex gap-2">
            <button type="button" className="btn btn-soft-primary fs-14">
              <i className="las la-filter fs-16 align-middle me-2"></i>Filter
            </button>
            <Dropdown.Toggle
              as="button"
